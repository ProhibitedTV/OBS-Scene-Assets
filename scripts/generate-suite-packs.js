...
const SUITES = [
  ...
  {
    collection: 'civic-broadcast',
    name: 'Civic Broadcast',
    label: 'Civic Broadcast Suite',
    eyebrow: 'Clear framing for commentary and public-interest coverage',
    audience: 'analysis streams, issue explainers, live reactions, and public-interest creator coverage',
    colors: {
      accent: '#60a5fa',
      ...
      line: 'rgba(239, 246, 255, 0.16)',
      surface: 'rgba(13, 23, 43, 0.72)',
      surfaceStrong: 'rgba(13, 23, 43, 0.92)',
      backdropStart: '#08101c',
      backdropMid: '#11223f',
      backdropEnd: '#24120f',
    },
    startTitle: 'Coverage begins in a moment',
    startHeadline: 'A white-label pre-show setup for analysis-led creator broadcasts.',
    breakTitle: 'Quick reset before the next segment',
    breakHeadline: 'Useful for ad breaks, fact-check resets, or guest handoffs.',
    scheduleTitle: 'Tonight\'s coverage outline',
    closingTitle: 'Thanks for staying with the full breakdown',
    backgroundTitle: 'Structured backdrop for public-interest coverage',
    alertTitle: 'New update on deck',
    alertHeadline: 'A fresh talking point just landed.',
    goalTitle: 'Reach the next coverage milestone',
    promoTitle: 'The next segment ahead',
    promoHeadline: 'Use the card for notes, guest topics, or community prompts',
    promoDescription: 'Built for commentary and analysis formats without locking the visuals to any specific network or issue.',
    scheduleItems: [
      'Opening context and key questions',
      'Main breakdown or live reaction block',
      'Guest, caller, or chat pulse segment',
      'Closing recap with next watch items',
    ],
    promoItems: [
      'Useful for rundown notes and guest prompts',
      'Broadcast-adjacent without being imitation news branding',
      'Easy to adapt for explainers or reaction streams',
    ],
    overlayItems: [
      'Main topic',
      'Key update',
    ...
    tags: ['analysis', 'broadcast', 'civic', 'commentary', 'news-adjacent', 'white-label'],
  },
  {
    collection: 'creator-commerce',
    name: 'Creator Commerce',
    label: 'Creator Commerce Suite',
    eyebrow: 'Sales-ready assets for drops and sponsor moments',
    audience: 'merch launches, affiliate pushes, live shopping, and sponsor-led creator campaigns',
    colors: {
      accent: '#fb7185',
      accentSecondary: '#8b5cf6',
      accentTertiary: '#f59e0b',
      ...
      surface: 'rgba(38, 13, 31, 0.72)',
      surfaceStrong: 'rgba(38, 13, 31, 0.92)',
      backdropStart: '#150712',
      backdropMid: '#2d1131',
      backdropEnd: '#28110d',
    },
    startTitle: 'Drop goes live in a minute',
    startHeadline: 'Built for launch windows, promo stacks, and creator storefront scenes.',
    breakTitle: 'Quick reset between promo beats',
    breakHeadline: 'Use this for product swaps, partner reads, or checkout reminders.',
    scheduleTitle: 'Launch and promo flow',
    closingTitle: 'Thanks for showing up for the drop',
    backgroundTitle: 'Bright commerce loop for launch-ready scenes',
    alertTitle: 'Conversion moment incoming',
    alertHeadline: 'A new offer beat just opened.',
    goalTitle: 'Unlock the next launch target',
    promoTitle: 'What\'s dropping next',
    promoHeadline: 'Use the card for offers, bundles, and sponsor hooks',
    promoDescription: 'Designed for creator storefront moments while staying generic enough for many sponsor and campaign types.',
    scheduleItems: [
      'Opening countdown and offer context',
      'Main product, merch, or sponsor beat',
      'Q-and-A, bundle notes, or live demos',
      'Final CTA and next-launch teaser',
    ],
    promoItems: [
      'Great for product cards and launch bullets',
      'Strong CTA framing without hardcoding a brand',
      'Works for merch, affiliates, and partner campaigns',
    ],
    overlayItems: [
      'Offer lane',
      'Bundle note',
    ...
    tags: ['commerce', 'creator', 'drop', 'merch', 'shopping', 'white-label'],
  },
  {
    collection: 'holiday-celebration',
    name: 'Holiday Celebration',
    label: 'Holiday Celebration Suite',
    eyebrow: 'Seasonal energy without hardcoded branding baggage',
    audience: 'holiday streams, end-of-year specials, community events, and seasonal creator programming',
    colors: {
      accent: '#22c55e',
      accentSecondary: '#ef4444',
      accentTertiary: '#facc15',
      text: '#f7fee7',
      muted: 'rgba(247, 254, 231, 0.78)',
      line: 'rgba(247, 254, 231, 0.16)',
      surface: 'rgba(18, 31, 19, 0.72)',
      surfaceStrong: 'rgba(18, 31, 19, 0.92)',
      backdropStart: '#07110a',
      backdropMid: '#17331a',
      backdropEnd: '#2d140e',
    },
    startTitle: 'Seasonal show starts soon',
    startHeadline: 'A festive but white-label intro for community specials and holiday events.',
    breakTitle: 'Quick pause before the next celebration beat',
    breakHeadline: 'Use this during games, gift segments, or set changes.',
    scheduleTitle: 'Tonight\'s seasonal rundown',
    closingTitle: 'Thanks for celebrating with us',
    backgroundTitle: 'Festive loop for seasonal creator scenes',
    alertTitle: 'Fresh celebration moment',
    alertHeadline: 'The next holiday beat is live.',
    goalTitle: 'Reach the next celebration milestone',
    promoTitle: 'What\'s coming up next',
    promoHeadline: 'Use the card for games, gifts, and sponsor surprises',
    promoDescription: 'Seasonal enough to feel special while still broad enough for many creators and end-of-year formats.',
    scheduleItems: [
      'Opening countdown and community hello',
      'Main event, game, or special segment',
      'Break for gifting, shout-outs, or chat prompts',
      'Closing wrap-up and next event preview',
    ],
    promoItems: [
      'Great for seasonal prompts and event bullets',
      'Keeps the vibe festive without licensed motifs',
      'Easy to recolor for different seasonal moods',
    ],
    overlayItems: [
      'Special moment',
      'Community note',
    ...
    tags: ['celebration', 'community-event', 'holiday', 'seasonal', 'special', 'white-label'],
  },
  {
    collection: 'maker-garage',
    name: 'Maker Garage',
    label: 'Maker Garage Suite',
    eyebrow: 'Practical framing for build streams and workshop demos',
    audience: 'maker streams, build logs, repair sessions, engineering demos, and hands-on creator workshops',
    colors: {
      accent: '#f97316',
      ...
      muted: 'rgba(255, 247, 237, 0.78)',
      line: 'rgba(255, 247, 237, 0.16)',
      surface: 'rgba(34, 20, 10, 0.72)',
      surfaceStrong: 'rgba(34, 20, 10, 0.92)',
      backdropStart: '#110b07',
      backdropMid: '#2c1c12',
      backdropEnd: '#0b1c21',
    },
    startTitle: 'Workshop opens in just a minute',
    startHeadline: 'Built for practical demos, builds, and hands-on walkthrough streams.',
    breakTitle: 'Quick bench reset before the next step',
    breakHeadline: 'Useful for tool swaps, camera changes, or short cooldown breaks.',
    scheduleTitle: 'Build plan and checkpoints',
    closingTitle: 'Thanks for building along tonight',
    backgroundTitle: 'Workshop-ready loop for maker broadcasts',
    alertTitle: 'Fresh build milestone',
    alertHeadline: 'The project just hit a new checkpoint.',
    goalTitle: 'Complete the next maker milestone',
    promoTitle: 'Next step on the bench',
    promoHeadline: 'Use the card for parts, goals, or sponsor tools',
    promoDescription: 'A strong white-label fit for workshop scenes, prototypes, repairs, and creator engineering sessions.',
    scheduleItems: [
      'Opening context and parts overview',
      'Main build or troubleshooting block',
      'Tool swap, camera shift, or Q-and-A',
      'Recap and next-step plan',
    ],
    promoItems: [
      'Great for checklists, part callouts, and milestones',
      'Works for tech, crafts, repairs, and fabrication',
      'Keeps the stream feeling structured and practical',
    ],
    overlayItems: [
      'Current step',
      'Tool note',
    ...
    tags: ['build', 'garage', 'maker', 'repair', 'workshop', 'white-label'],
  },
  {
    collection: 'podcast-studio',
    name: 'Podcast Studio',
    label: 'Podcast Studio Suite',
    eyebrow: 'Conversation-first assets for talk-led shows',
    audience: 'podcasts, live interviews, call-in shows, and creator roundtable broadcasts',
    colors: {
      accent: '#8b5cf6',
      ...
      muted: 'rgba(245, 243, 255, 0.78)',
      line: 'rgba(245, 243, 255, 0.16)',
      surface: 'rgba(17, 16, 42, 0.72)',
      surfaceStrong: 'rgba(17, 16, 42, 0.92)',
      backdropStart: '#080811',
      backdropMid: '#171739',
      backdropEnd: '#160a1f',
    },
    startTitle: 'Mic check before we go live',
    startHeadline: 'Designed for guest-led shows, creator roundtables, and conversation-driven streams.',
    breakTitle: 'Quick reset between segments',
    breakHeadline: 'Use this during ad reads, topic shifts, or guest swaps.',
    scheduleTitle: 'Episode flow at a glance',
    closingTitle: 'Thanks for staying for the whole conversation',
    backgroundTitle: 'Studio-style loop for talk-led creator scenes',
    alertTitle: 'Fresh segment beat',
    alertHeadline: 'A new topic lane just opened.',
    goalTitle: 'Hit the next audience milestone',
    promoTitle: 'What we talk through next',
    promoHeadline: 'Use the card for guest prompts, sponsor notes, or episode CTAs',
    promoDescription: 'A white-label conversation pack that works for podcasts, interviews, and creator desk shows.',
    scheduleItems: [
      'Opening context and guest framing',
      'Main discussion or interview block',
      'Q-and-A, sponsor read, or listener prompt',
      'Closing recap and next-episode CTA',
    ],
    promoItems: [
      'Great for guest notes and sponsor bullets',
      'Studio feel without mimicking one network',
      'Clean enough for serious or casual talk formats',
    ],
    overlayItems: [
      'Current topic',
      'Guest lane',
    ...
    tags: ['interview', 'podcast', 'roundtable', 'talk-show', 'studio', 'white-label'],
  },
  {
    collection: 'study-session',
    name: 'Study Session',
    label: 'Study Session Suite',
    eyebrow: 'Focus-friendly assets for calm productive streams',
    audience: 'study streams, coding sessions, coworking rooms, and long-form focus broadcasts',
    colors: {
      accent: '#38bdf8',
      accentSecondary: '#84cc16',
      accentTertiary: '#facc15',
      ...
      muted: 'rgba(240, 253, 244, 0.78)',
      line: 'rgba(240, 253, 244, 0.16)',
      surface: 'rgba(8, 26, 24, 0.72)',
      surfaceStrong: 'rgba(8, 26, 24, 0.92)',
      backdropStart: '#071110',
      backdropMid: '#0d2623',
      backdropEnd: '#171d0c',
    },
    startTitle: 'Focus block starts in a minute',
    startHeadline: 'A calm white-label intro for coworking, coding, and long-form focus sessions.',
    breakTitle: 'Short pause before the next sprint',
    breakHeadline: 'Use this during Pomodoro resets, hydration breaks, or session swaps.',
    scheduleTitle: 'Focus session layout',
    closingTitle: 'Nice work getting through the session',
    backgroundTitle: 'Soft productivity loop for study scenes',
    alertTitle: 'New focus checkpoint',
    alertHeadline: 'The next sprint is ready.',
    goalTitle: 'Reach the next deep-work milestone',
    promoTitle: 'The next sprint ahead',
    promoHeadline: 'Use the card for goals, playlists, and check-in notes',
    promoDescription: 'Built for productivity streams that need structure without loud visual clutter.',
    scheduleItems: [
      'Opening focus goal and timer setup',
      'Main work sprint or study block',
      'Short pause and community check-in',
      'Closing recap with next target',
    ],
    promoItems: [
      'Great for checklists and sprint goals',
      'Works for study, coding, journaling, or coworking',
      'Keeps the atmosphere calm and intentional',
    ],
    overlayItems: [
      'Current sprint',
      'Focus cue',
    ...
    tags: ['coding', 'coworking', 'focus', 'productivity', 'study', 'white-label'],
  },
  {
    collection: 'tournament-desk',
    name: 'Tournament Desk',
    label: 'Tournament Desk Suite',
    eyebrow: 'Analyst-ready framing for competitive broadcasts',
    audience: 'bracket shows, esports desks, tournament recaps, and match-day creator coverage',
    colors: {
      accent: '#ef4444',
      accentSecondary: '#f59e0b',
      accentTertiary: '#22d3ee',
      text: '#fef2f2',
      muted: 'rgba(254, 242, 242, 0.78)',
      line: 'rgba(254, 242, 242, 0.16)',
      surface: 'rgba(34, 11, 15, 0.72)',
      surfaceStrong: 'rgba(34, 11, 15, 0.92)',
      backdropStart: '#12070a',
      backdropMid: '#2d0f17',
      backdropEnd: '#101824',
    },
    startTitle: 'Desk coverage starts soon',
    startHeadline: 'Built for brackets, match intros, and fast analyst-desk creator coverage.',
    breakTitle: 'Short reset before the next matchup',
    breakHeadline: 'Use this during halftimes, desk swaps, or bracket recaps.',
    scheduleTitle: 'Match-day rundown',
    closingTitle: 'Thanks for watching the full bracket run',
    backgroundTitle: 'High-energy desk loop for tournament scenes',
    alertTitle: 'Bracket shift incoming',
    alertHeadline: 'A fresh match beat just landed.',
    goalTitle: 'Reach the next desk milestone',
    promoTitle: 'Next matchup on deck',
    promoHeadline: 'Use the card for pairings, picks, and sponsor reads',
    promoDescription: 'Designed for competitive coverage without hardwiring the visuals to one title or league.',
    scheduleItems: [
      'Opening desk setup and match framing',
      'Main reaction or analyst segment',
      'Bracket update, predictions, or halftime notes',
      'Closing recap with next match CTA',
    ],
    promoItems: [
      'Great for match cards and bracket bullets',
      'Keeps a competitive tone without licensing baggage',
      'Works for esports, creator leagues, and fan events',
    ],
    overlayItems: [
      'Current matchup',
      'Desk note',
    ...
    tags: ['analyst', 'bracket', 'competitive', 'desk', 'tournament', 'white-label'],
  },
  {
    collection: 'vtuber-spotlight',
    name: 'VTuber Spotlight',
    label: 'VTuber Spotlight Suite',
    eyebrow: 'Avatar-first framing for performance and lore-driven streams',
    audience: 'VTuber debuts, avatar-first shows, lore streams, and stylized creator collabs',
    colors: {
      accent: '#ec4899',
      accentSecondary: '#8b5cf6',
      accentTertiary: '#22d3ee',
      text: '#fdf2f8',
      muted: 'rgba(253, 242, 248, 0.78)',
      line: 'rgba(253, 242, 248, 0.16)',
      surface: 'rgba(34, 10, 30, 0.72)',
      surfaceStrong: 'rgba(34, 10, 30, 0.92)',
      backdropStart: '#140713',
      backdropMid: '#2b1033',
      backdropEnd: '#0c1a29',
    },
    startTitle: 'Debut stage opens in a minute',
    startHeadline: 'Built for avatar-first streams that need big stage energy and white-label flexibility.',
    breakTitle: 'Short scene reset before the next reveal',
    breakHeadline: 'Useful for lore beats, karaoke swaps, or collab handoffs.',
    scheduleTitle: 'Tonight\'s spotlight flow',
    closingTitle: 'Thanks for staying through the full spotlight',
    backgroundTitle: 'Stage-loop backdrop for avatar-led scenes',
    alertTitle: 'Fresh spotlight moment',
    alertHeadline: 'The next reveal cue is live.',
    goalTitle: 'Reach the next spotlight milestone',
    promoTitle: 'What reveals next',
    promoHeadline: 'Use the card for lore beats, collabs, and event drops',
    promoDescription: 'An avatar-first pack with strong stage energy that still stays generic enough for many VTuber identities.',
    scheduleItems: [
      'Opening stage countdown and audience greeting',
      'Main debut, collab, or performance block',
      'Interlude for chat prompts or lore notes',
      'Closing CTA and next-show teaser',
    ],
    promoItems: [
      'Great for lore cards and collab announcements',
      'Strong stylization without tying to one character brand',
      'Useful for debuts, karaoke, and variety streams',
    ],
    overlayItems: [
      'Current act',
      'Lore note',
    ...
    tags: ['avatar', 'debut', 'lore', 'performance', 'vtuber', 'white-label'],
  },
];
